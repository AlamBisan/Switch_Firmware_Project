# Bug Report: test_out_of_range_vlan_is_rejected[4095]

- **Test ID**: `tests/security/test_vlan_boundary.py::test_out_of_range_vlan_is_rejected[4095]`
- **Category**: security
- **Severity**: High
...
## Reproduction
```
pytest -v "tests/security/test_vlan_boundary.py::test_out_of_range_vlan_is_rejected[4095]"
```

## Failure Details
```
firmware = <dut.firmware.SwitchFirmware object at 0x000001CF25561A30>
invalid_vlan = 4095
...
E       AssertionError: VLAN 4095 was accepted -- BUG-003 (missing VLAN range validation) has resurfaced
E       assert not True
