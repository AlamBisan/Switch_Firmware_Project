# Bug Report: test_out_of_range_vlan_is_rejected[0]

- **Test ID**: `tests/security/test_vlan_boundary.py::test_out_of_range_vlan_is_rejected[0]`
- **Category**: security
- **Severity**: High
...
## Reproduction
```
pytest -v "tests/security/test_vlan_boundary.py::test_out_of_range_vlan_is_rejected[0]"
```

## Failure Details
```
firmware = <dut.firmware.SwitchFirmware object at 0x000001CF25561BE0>
invalid_vlan = 0
...
E       AssertionError: VLAN 0 was accepted -- BUG-003 (missing VLAN range validation) has resurfaced
E       assert not True
