# Bug Report: test_out_of_range_vlan_is_rejected[-1]

- **Test ID**: `tests/security/test_vlan_boundary.py::test_out_of_range_vlan_is_rejected[-1]`
- **Category**: security
- **Severity**: High
...
## Reproduction
```
pytest -v "tests/security/test_vlan_boundary.py::test_out_of_range_vlan_is_rejected[-1]"
```

## Failure Details
```
firmware = <dut.firmware.SwitchFirmware object at 0x000001CF25561AC0>
invalid_vlan = -1
...
E       AssertionError: VLAN -1 was accepted -- BUG-003 (missing VLAN range validation) has resurfaced
E       assert not True
